...
# for skill_name, skill_info in user_skills.skills.items():
#     print(f"Skill Name: {skill_name}")
#     print(f"Symbol: {skill_info['symbol']}")
#     print(f"Definition: {skill_info['definition']}")
#     print(f"Similarity: {skill_info['similarity']}")
#     print()